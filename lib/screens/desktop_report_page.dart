...
class DesktopReportPage extends StatefulWidget {
  const DesktopReportPage({super.key});

  @override
  State<DesktopReportPage> createState() => _DesktopReportPageState();
}

class _DesktopReportPageState extends State<DesktopReportPage> {
            ...
            NavigationRail(
              ...
              destinations: const [
                ...
                NavigationRailDestination(
                  ...
                  label: Text('Sales', style: TextStyle(color: Colors.white)),
                ),
                NavigationRailDestination(
  ...
  Widget _buildPageContent() {
    switch (_selectedIndex) {
      ...
      case 1:
        return _buildPurchaseCard(context);
      case 2:
        return _buildSaleCard(context);
      case 3:
        return _buildExpenseCard(context);
      case 4:
        return _buildDeliveryCard(context);
      case 5:
        return _buildStockRemainCard(context);
      default:
